...
export declare const WA_CHAT_KEY: (c: WAChat) => number;
export declare const WA_CHAT_KEY_PIN: (c: WAChat) => number;
export declare const WA_MESSAGE_KEY: (m: WAMessage) => number;
