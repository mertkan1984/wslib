...
exports.extensionForMediaMessage = exports.decodeMediaMessageBuffer = exports.generateThumbnail = exports.mediaMessageSHA256B64 = exports.ProxyAgent = exports.generateProfilePicture = exports.compressImage = exports.getMediaKeys = exports.decryptWA = exports.generateMessageID = exports.generateClientID = exports.generateMessageTag = exports.promiseTimeout = exports.delayCancellable = exports.delay = exports.unixTimestampSeconds = exports.randomBytes = exports.hkdf = exports.sha256 = exports.hmacSign = exports.aesEncrypWithIV = exports.aesEncrypt = exports.aesDecryptWithIV = exports.aesDecrypt = exports.shallowChanges = exports.isGroupID = exports.whatsappID = exports.GET_MESSAGE_ID = exports.WA_MESSAGE_ID = exports.WA_MESSAGE_KEY = exports.WA_CHAT_KEY_PIN = exports.WA_CHAT_KEY = exports.toNumber = exports.Browsers = void 0;
...
exports.WA_CHAT_KEY = (c) => ((c.t * 100000) + (hashCode(c.jid) % 100000)) * -1; // -1 to sort descending
exports.WA_CHAT_KEY_PIN = (c) => ((c.t * 100000) * (c.pin ? 2 : 1) + (hashCode(c.jid) % 100000)) * -1; // -1 to sort descending
exports.WA_MESSAGE_KEY = (m) => exports.toNumber(m.messageTimestamp) * 1000 + (m['epoch'] || 0) % 1000;
