...
class WAConnection extends events_1.EventEmitter {
    constructor() {
        ...
        this.chatOrderingKey = Utils.WA_CHAT_KEY;
        this.maxCachedMessages = 50;
        this.chats = new keyed_db_1.default(Utils.WA_CHAT_KEY, value => value.jid);
        this.contacts = {};
    ...
    endConnection() {
        ...
        //this.conn?.close ()
        (_e = this.conn) === null || _e === void 0 ? void 0 : _e.terminate();
        this.conn = null;
        this.lastSeen = null;
